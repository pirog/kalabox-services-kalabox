...
COMMAND=$1
EXIT_VALUE=0
PLUGIN_REPO="kalabox/kalabox-services-kalabox"
...
before-install() {
  ...
  if ([ $TRAVIS_BRANCH == "master" ] || [ ! -z "$TRAVIS_TAG" ]) &&
    ...
    openssl aes-256-cbc -K $encrypted_b38ec719bda4_key -iv $encrypted_b38ec719bda4_iv -in ci/travis.id_rsa.enc -out $HOME/.ssh/travis.id_rsa -d
  fi
}
