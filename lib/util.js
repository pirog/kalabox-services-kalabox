...
module.exports = function(kbox) {
    ...
    .then(function(adapter) {
      ...
      .then(function(ips) {
        ...
        if (needsWin32DNS()) {
          ...
          // Run Commands
          // @todo: this is currently not blocking but as soon
          // as this finishes it seems to kill the whole process?
          windosu.exec(cmd);
        }
  ...
  /*
   * Helper function to determine whether we need to run darwin DNS commands
   * @todo: we need a better way to do this on linux
   */
  var needsDNS = function() {
    return needsDarwinDNS() || needsWin32DNS();
  };
