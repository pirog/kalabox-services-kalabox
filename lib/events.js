...
module.exports = function(kbox) {
   ...
   */
  kbox.core.events.on('post-start-component', function(cmp, done) {
      ...
      .then(function(data) {
        ...
        return Promise.map(cmp.proxy, function(proxy) {
          ...
          if (port) {
            ...
            // Build a destination.
            var destination = ['http://', redisIp, ':', port].join('');
   ...
   */
  kbox.core.events.on('post-uninstall-component', function(cmp, done) {
